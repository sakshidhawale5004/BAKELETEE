...
const FollowCrumbs = () => {
  useEffect(() => {
    ...
    // Small delay to ensure React has rendered the blockquotes
  ...
  return (
    <section id="follow" className="py-24 md:py-32 bg-gradient-warm overflow-hidden">
      <div className="container px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8 max-w-7xl mx-auto items-start">
          {reels.map((url, i) => (
            <div
              key={i}
