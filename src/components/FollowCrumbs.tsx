    ...
    <div className="container">
          ...
          return (
            ...
            >
              <img
                ...
                onError={(e) => {
                  // Fallback if Instagram blocks the direct media link
                  (e.target as HTMLImageElement).src = "https://images.unsplash.com/photo-1558961363-fa8fdf82db35?q=80&w=800&auto=format&fit=crop";
                }}
              />
              ...
              <div className="absolute top-3 right-3 w-9 h-9 rounded-full bg-background/90 backdrop-blur flex items-center justify-center text-primary shadow-soft transform group-hover:scale-110 transition-transform">
                <svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/></svg>
              </div>
              <div className="absolute bottom-3 inset-x-3 text-primary-foreground text-xs font-medium drop-shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">
                ▶ {r.caption}
              </div>
            </a>
          );
      ...
      <div className="mt-12 flex flex-wrap justify-center gap-4">
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="inline-flex items-center gap-2 rounded-full border-2 border-primary text-primary px-7 py-3 font-semibold hover:bg-primary hover:text-primary-foreground transition-all shadow-sm"
        >
