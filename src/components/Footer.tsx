      ...
      <div className="md:col-span-2 lg:col-span-2">
        ...
        <div className="flex flex-wrap gap-3">
          ...
          <a
            ...
            className="w-10 h-10 rounded-full bg-primary-foreground/10 hover:bg-primary hover:text-ink flex items-center justify-center transition-all text-primary-foreground/80 hover:scale-110"
          >
