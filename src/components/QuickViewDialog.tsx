...
const QuickViewDialog = ({ product, onClose }: Props) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-4xl max-h-[92vh] overflow-y-auto bg-background rounded-3xl shadow-3d border border-border animate-scale-in grid md:grid-cols-2">
        {/* Close button */}
        <button
          onClick={onClose}
        ...
        <div className="p-6 md:p-10 flex flex-col">
          ...
          <div className="mt-auto pt-8 flex items-end justify-between gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 rounded-full bg-[#25D366] text-white px-6 py-3.5 font-semibold shadow-3d hover:-translate-y-0.5 hover:brightness-110 transition-all"
            >
          ...
          <p className="mt-3 text-xs text-muted-foreground text-center">
            Baked fresh to order · 25% advance confirms your slot
          </p>
        </div>
      </div>
    </div>
