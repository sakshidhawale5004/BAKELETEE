  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-16 h-16 rounded-full bg-[#25D366] text-white shadow-3d flex items-center justify-center pulse-soft hover:scale-110 transition-transform"
      >
      ...
      {/* Popup card */}
      {open && (
        <div className="fixed bottom-28 right-6 z-50 w-[320px] bg-background rounded-3xl shadow-3d border border-border overflow-hidden fade-up">
