  ...
  <main className="min-h-screen bg-background flex flex-col">
    ...
    <div className="container mx-auto py-32 px-4 max-w-3xl flex-1 mt-16">
      ...
      <div className="prose prose-lg text-muted-foreground leading-relaxed space-y-6">
        <p>There's a moment in the kitchen when something ordinary transforms into something extraordinary. For us, that moment is when butter hits the pan and slowly shifts from pale yellow to a deep, amber gold — releasing the most intoxicating aroma you'll ever smell. That's brown butter. And it's the secret behind some of our most beloved cookies.</p>
